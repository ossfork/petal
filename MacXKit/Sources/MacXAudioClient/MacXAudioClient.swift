...
public enum MacXAudioClientError: LocalizedError, Sendable {
    case notRecording
    case failedToStart
...
@DependencyClient
public struct MacXAudioClient: Sendable {
...
extension MacXAudioClient: DependencyKey {
...
extension MacXAudioClient: TestDependencyKey {
...
public extension DependencyValues {
    var macXAudioClient: MacXAudioClient {
        get { self[MacXAudioClient.self] }
        set { self[MacXAudioClient.self] = newValue }
    }
}
...
private final class LiveAudioCaptureRuntime: NSObject {
    ...
    func startRecording(levelHandler: @escaping @Sendable (Double) -> Void) throws {
        ...
        guard recorder.record() else {
            throw MacXAudioClientError.failedToStart
        }
    ...
    func stopRecording() throws -> URL {
        guard let recorder else {
            throw MacXAudioClientError.notRecording
        }
