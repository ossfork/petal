...
public enum MacXPasteResult: Equatable, Sendable {
    case pasted
    case copiedOnly
}

@DependencyClient
public struct MacXPasteClient: Sendable {
    public var paste: @Sendable (String) async -> MacXPasteResult = { _ in .copiedOnly }
}

extension MacXPasteClient: DependencyKey {
...
extension MacXPasteClient: TestDependencyKey {
...
public extension DependencyValues {
    var macXPasteClient: MacXPasteClient {
        get { self[MacXPasteClient.self] }
        set { self[MacXPasteClient.self] = newValue }
    }
}
...
private final class LivePasteRuntime {
    ...
    func paste(text: String) async -> MacXPasteResult {
