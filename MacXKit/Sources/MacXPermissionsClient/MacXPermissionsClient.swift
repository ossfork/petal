...
@DependencyClient
public struct MacXPermissionsClient: Sendable {
...
extension MacXPermissionsClient: DependencyKey {
...
extension MacXPermissionsClient: TestDependencyKey {
...
public extension DependencyValues {
    var macXPermissionsClient: MacXPermissionsClient {
        get { self[MacXPermissionsClient.self] }
        set { self[MacXPermissionsClient.self] = newValue }
    }
}
