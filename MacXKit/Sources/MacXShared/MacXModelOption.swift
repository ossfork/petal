...
public struct MacXModelDescriptor: Sendable, Equatable {
...
public enum MacXModelOption: String, CaseIterable, Identifiable, Sendable {
    case mini3b = "mini-3b"
    ...
    public var descriptor: MacXModelDescriptor {
        switch self {
        case .mini3b:
            return MacXModelDescriptor(
                id: rawValue,
