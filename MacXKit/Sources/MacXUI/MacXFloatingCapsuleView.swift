...
@MainActor
@Observable
public final class MacXFloatingCapsuleState {
...
public struct MacXFloatingCapsuleView: View {
    @Bindable var state: MacXFloatingCapsuleState

    public init(state: MacXFloatingCapsuleState) {
        self.state = state
    }
